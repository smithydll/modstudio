 ...
 *
 *   $Id: AuthorEditorDialogBox.cs,v 1.12 2007-09-01 13:52:37 smithydll Exp $
 *
 *
 ***************************************************************************/
...
namespace ModStudio
{
	...
	public class AuthorEditorDialogBox : System.Windows.Forms.Form
	{
		...
		public ModAuthor Entry
		{
			get
			{
				return new ModAuthor(textBoxUserName.Text, textBoxRealName.Text, textBoxEmail.Text, textBoxWebpage.Text);
			}
			set
			{
