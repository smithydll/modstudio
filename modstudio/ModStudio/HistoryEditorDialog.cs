 ...
 *
 *   $Id: HistoryEditorDialog.cs,v 1.1 2005-08-22 05:44:49 smithydll Exp $
 *
 *
 ***************************************************************************/
...
namespace ModStudio
{
	...
	/// </summary>
	public class HistoryEditorDialog : System.Windows.Forms.Form
	{
		...
		private void buttonOk_Click(object sender, System.EventArgs e)
		{
			...
			{
				this.Save(this, new HistoryEditorDialogSaveEventArgs(new ModTemplateTools.PhpbbMod.ModHistoryEntry(new ModTemplateTools.PhpbbMod.ModVersion((int)MODVersionMajor.Value, (int)MODVersionMinor.Value, (int)MODVersionRevision.Value, MODVersionRelease.Text[0]), MODHistorydtp.Value, new ModTemplateTools.PhpbbMod.PropertyLang(textBoxEntry.Text))));
			}
			else
			{
				this.Save(this, new HistoryEditorDialogSaveEventArgs(new ModTemplateTools.PhpbbMod.ModHistoryEntry(new ModTemplateTools.PhpbbMod.ModVersion((int)MODVersionMajor.Value, (int)MODVersionMinor.Value, (int)MODVersionRevision.Value), MODHistorydtp.Value, new ModTemplateTools.PhpbbMod.PropertyLang(textBoxEntry.Text))));
			}
			this.Hide();
		}
		...
		/// 
		/// </summary>
		public delegate void HistoryEditorDialogSaveHandler(object sender, HistoryEditorDialogSaveEventArgs e);
		/// <summary>
		/// 
		/// </summary>
		public event HistoryEditorDialogSaveHandler Save;
	...
	/// 
	/// </summary>
	public class HistoryEditorDialogSaveEventArgs: EventArgs 
	{
		/// <summary>
		/// 
		/// </summary>
		...
		/// </summary>
		/// <param name="entry"></param>
		public HistoryEditorDialogSaveEventArgs(ModTemplateTools.PhpbbMod.ModHistoryEntry entry) 
		{
			this.Entry = entry;
		}
	}
