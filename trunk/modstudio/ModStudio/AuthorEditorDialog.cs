 ...
 *
 *   $Id: AuthorEditorDialog.cs,v 1.1 2005-08-22 05:44:49 smithydll Exp $
 *
 *
 ***************************************************************************/
...
{
	/// <summary>
	/// Summary description for AuthorEditorDialog.
	/// </summary>
	public class AuthorEditorDialog : System.Windows.Forms.Form
	{
		...
		/// 
		/// </summary>
		public delegate void AuthorDialogSaveHandler(object sender, AuthorDialogSaveEventArgs e);
		/// <summary>
		/// 
		/// </summary>
		public event AuthorDialogSaveHandler Save;
		...
		{
			this.Save(this, new AuthorDialogSaveEventArgs(textBoxUserName.Text, textBoxRealName.Text, textBoxEmail.Text, textBoxWebpage.Text));
			this.Hide();
		}
	...
	/// 
	/// </summary>
	public class AuthorDialogSaveEventArgs: EventArgs 
	{
		/// <summary>
		/// 
		/// </summary>
		...
		/// <param name="email"></param>
		/// <param name="website"></param>
		public AuthorDialogSaveEventArgs(string username, string realname, string email, string website) 
		{
