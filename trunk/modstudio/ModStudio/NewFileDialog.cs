 ...
 *
 *   $Id: NewFileDialog.cs,v 1.1 2007-09-01 13:52:38 smithydll Exp $
 *
 *
 ***************************************************************************/
...
namespace ModStudio
{
    ...
    /// 
    /// </summary>
    class NewFileDialog : System.Windows.Forms.CommonDialog
    {
        public event NewFileDialogBox.NewFileDialogBoxSaveNewHandler NewFile;
        ...
        {
            NewFileDialogBox dialogInstance = null;
            bool okTriggered = false;
            try
            {
                dialogInstance = new NewFileDialogBox();
                ...
                if (dialogInstance.ShowDialog() == DialogResult.OK)
                {
                    ...
                    this.NewFile(this, new NewFileDialogBoxSaveNewEventArgs(dialogInstance.FileName, dialogInstance.FileType));
                }
            }
