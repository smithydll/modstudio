 ...
 *
 *   $Id: AboutBox.cs,v 1.10 2007-09-01 13:52:37 smithydll Exp $
 *
 *
 ***************************************************************************/
...
namespace ModStudio
{
	...
	public class AboutBox : System.Windows.Forms.Form
	{
		...
		private void AboutBox_Load(object sender, System.EventArgs e)
		{
			...
			label3.Text = "Copyright © 2005-2007 David Smith (smithy_dll). All rights reserved. All logos and graphics are copyright David Smith. Some logos and graphics under license (GPL) from the phpBB group.\n\nTextbox component from http://icsharpcode.net/\n\nLicensed under the GPL.";
		}
	}
}
